...
public class HashTableImplTest {
    ...
    //Found problem in my Hashtable: When I get to more than 3 nodes per list: 
    //the second node overwrites the first and the third is added to what was the second but is now the first.
    //This is because when i set up previousNode and currentNode they are pointing straight to the place in memory where the nodes are:
    //This means when i change those variables, I am now changing that place in memory.
    @Test
