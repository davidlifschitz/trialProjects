...
public class DocumentImplTest {
    ...
    public void setUp() throws Exception {
        this.textUri = new URI("/Users/TheBigLipper/LifschitzDavid/DataStructures/project/stage1/src/main/java/edu/yu/cs/com1320/txt.txt");
        this.textString = "This is text content. Lots of it.";
        this.textHashCode = this.textString.hashCode();

        this.pdfUri = new URI("/Users/TheBigLipper/LifschitzDavid/DataStructures/project/stage1/src/main/java/edu/yu/cs/com1320/pdf.pdf");
