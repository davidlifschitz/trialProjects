...
public class HashTableImpl<Key, Value> implements HashTable<Key, Value> {
    ...
    private int HashFunction(Key myKey) {
        ...
        int returnInt = (hashCode % this.entryArray.length);
        returnInt = Math.abs(returnInt) & 0x7fffffff;
        return returnInt;
    }
            ...
            if (currentNode.hashCode.equals((int) (k.hashCode()))) {
                ...
                if (v != null) {
                    ...
                    if (previousNode == null) {
                        if(this.entryArray[id].header.next == null) this.entryArray[id].header = null;
                        else
                        {
                            this.entryArray[id].header = this.entryArray[id].header.next;
                        }
