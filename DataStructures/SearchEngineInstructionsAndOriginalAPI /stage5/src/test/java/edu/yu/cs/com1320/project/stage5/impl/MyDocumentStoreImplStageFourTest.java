...
public class MyDocumentStoreImplStageFourTest {
    private String txt1;
    private String txt2;
    private String txt3;
    private String txt4;
    ...
    private DocumentStoreImpl createStoreAndPutAll(){
        ...
        //doc3
        bas = new ByteArrayInputStream(this.pdfTxt3.getBytes());
        dsi.putDocument(bas,this.uri3, DocumentStore.DocumentFormat.TXT);
        //doc4
        bas = new ByteArrayInputStream(this.pdfTxt4.getBytes());
    ...
    public void testREGULARSEARCHChangeTimeWorksSuccess2() {
        ...
        assertEquals(this.pdfTxt3,oldestDoc.getWholeText());
    ...
    public void testREGULARSEARCHBYPREFIXhangeTimeWorksSuccess3() {
        ...
        System.out.println(oldDocString);
        System.out.println(txt2);
        System.out.println(txt4);
        assertTrue(oldDocString.equals(txt2) || oldDocString.equals(txt4) || oldDocString.equals(txt3));
    }
    ...
    // Dealing with Undos
    @Test
    public void testHeapAfterPutDeleteAndUndo()
    {
        DocumentStoreImpl dsi = createStoreAndPutAll();
        dsi.deleteDocument(this.uri1);
        dsi.undo();
        DocumentImpl oldestDoc = (DocumentImpl)dsi.memoryCollector.removeMin();
        assertTrue(oldestDoc.getWholeText().equals(this.pdfTxt3) ||oldestDoc.getWholeText().equals(this.txt1));
    }
    @Test
    public void testHeapAfterPutDeleteAllAndUndo()
    {
        DocumentStoreImpl dsi = createStoreAndPutAll();
        dsi.deleteAll("text");
        dsi.undo();
        DocumentImpl oldestDoc = (DocumentImpl)dsi.memoryCollector.removeMin();
        assertTrue(oldestDoc.getWholeText().equals(this.pdfTxt3) ||oldestDoc.getWholeText().equals(this.txt2));
    }
    @Test
    public void testHeapAfterPutDeleteAllWithPrefixAndUndo() {
        DocumentStoreImpl dsi = createStoreAndPutAll();
        dsi.deleteAllWithPrefix("tex");
        dsi.undo();
        DocumentImpl oldestDoc = (DocumentImpl)dsi.memoryCollector.removeMin();
        assertTrue(oldestDoc.getWholeText().equals(this.pdfTxt3) ||oldestDoc.getWholeText().equals(this.txt2));
    }
