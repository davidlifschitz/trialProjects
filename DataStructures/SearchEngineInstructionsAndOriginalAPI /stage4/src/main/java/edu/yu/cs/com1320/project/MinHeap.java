...
/**
 * Beginnings of a MinHeap, for Stage 4 of project. Does not include logic
 * needed throughout various methods to track an element's array index, which is
 * needed to reheapify an element after its last use time changes.
 * 
 * @param <E>
 */
public abstract class MinHeap<E extends Comparable> {
    ...
    /**
     * while the key at index k is less than its parent's key, swap its contents
     * with its parent’s
     */
    ...
    /**
     * move an element down the heap until it is less than both its children or is
    ...
    public void insert(E x) {
        ...
        this.elementsToArrayIndex.put(x, getArrayIndex(x));
    }
